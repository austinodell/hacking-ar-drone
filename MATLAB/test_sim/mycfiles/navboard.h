...
/* 	u16 size;                  Size of the following data (always 0x2C)    not read into struct anymore */
	...
	u16 unk3;                /*  unknown +0x1E Checksum = sum of all values except checksum (22 values) */
...
int nav_FlatTrim();
float nav_Get_gx(struct nav_struct* nav);
float nav_Get_gy(struct nav_struct* nav);
float nav_Get_gz(struct nav_struct* nav);
float nav_Get_ax(struct nav_struct* nav);
float nav_Get_ay(struct nav_struct* nav);
float nav_Get_az(struct nav_struct* nav);
float nav_Get_mx(struct nav_struct* nav);
float nav_Get_my(struct nav_struct* nav);
float nav_Get_mz(struct nav_struct* nav);
float nav_Get_height(struct nav_struct* nav);
