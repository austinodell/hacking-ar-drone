###########################################################################
## Makefile generated for Simulink model 'SPtest'. 
## 
## Makefile     : SPtest.mk
## Generated on : Thu Oct 02 14:52:15 2014
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SPtest.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/dkret/Documents/MATLAB
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = SPtest_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = SPtest_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SPtest.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/SPtest_grt_rtw -I$(START_DIR) -IC:/Users/dkret/Downloads -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(START_DIR)/slprj/grt/_sharedutils
...
DEFINES_STANDARD = -DMODEL=SPtest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/SPtest_grt_rtw/SPtest.c rt_logging.c
...
OBJS = SPtest.obj rt_logging.obj
...
%.obj : $(START_DIR)/SPtest_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" "$<"
